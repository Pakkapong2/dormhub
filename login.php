...
<body class="bg-gradient-to-br from-green-500 via-emerald-600 to-teal-700 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="glass-card shadow-2xl rounded-[2rem] p-8 md:p-12 w-full max-w-[450px] transition-all transform">
        ...
        <form method="POST" class="space-y-5">
            <div class="relative group">
                ...
                <input type="text" name="username" placeholder="ชื่อผู้ใช้" required 
                    class="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:bg-white transition-all text-slate-700">
            </div>
            ...
            <button type="submit" name="login" 
                class="w-full py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-slate-800 transform active:scale-[0.98] transition-all shadow-lg shadow-slate-200">
                เข้าสู่ระบบ
            </button>
        </form>
        ...
        <p class="mt-6 text-center text-slate-500 text-sm">
            ยังไม่มีบัญชี? 
            <a href="register.php" class="text-green-600 font-bold hover:text-green-700 transition">สมัครสมาชิกที่นี่</a>
        </p>
        ...
        <div class="mt-10 text-center">
            <p class="text-[10px] text-slate-400 uppercase tracking-widest">&copy; 2024 DORMHUB Management System</p>
        </div>
    </div>
